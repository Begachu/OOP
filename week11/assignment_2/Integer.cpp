...
Number *Integer::add(Number * num) {
    ...
    if (num->types() == INTEGER) {
		...
		Integer* return_num = new Integer(value+value_num->val());
		delete value_num;
		delete(this);
		return return_num;
    } else if (num->types() == FLOAT) {
		Float* value_num = dynamic_cast<Float*>(num);
		Float* return_num = new Float(value+value_num->val());
		delete value_num;
		delete this;
		return return_num;
    } else if (num->types() == COMPLEX) {
		Complex* value_num = dynamic_cast<Complex*>(num);
		Complex* return_num = new Complex(value+value_num->real(), value_num->imag());
		delete value_num;
		delete this;
		return return_num;
    }
...
Number *Integer::mul(Number * num) {
    ...
    if (num->types() == INTEGER) {
		...
		Complex* value_num = dynamic_cast<Complex*>(num);
		Complex* return_num = new Complex(value*value_num->real(), value*value_num->imag());
		delete value_num;
		delete this;
		return return_num;
    }
